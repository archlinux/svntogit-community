...
license=('GPL2')
depends=('jack' 'pulseaudio' 'python-dbus' 'python-pyqt4')
makedepends=('a2jmidid' 'jack_capture' 'pulseaudio-jack' 'python-rdflib' 'zita-ajbridge')
...
package() {
  ...
  # docs
  install -t "${pkgdir}/usr/share/doc/${pgkname}/" -Dm644 {README.md,TODO}
}
