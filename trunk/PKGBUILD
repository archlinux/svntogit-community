...
depends=('python' 'dbus-client-gen' 'python-dbus-client-gen' 'python-dbus-signature-pyparsing' 'python-into-dbus' 'python-justbytes' 'python-justbases' 'python-dateutil')
