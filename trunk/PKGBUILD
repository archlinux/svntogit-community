...
source=(
  $pkgname-$pkgver.tar.gz::https://github.com/falkTX/$pkgname/archive/v$pkgver.tar.gz
...
prepare() {
  # fix qt5.15 compatibility
  patch -Np1 -d $_name-$pkgver -i ../$pkgname-0.9.1-qt5.15.patch
}
